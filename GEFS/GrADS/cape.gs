...
while (Clev<=2)
  ...
  while (count < numbfor)
    ...
    if (Clev=2)
      ...
      'set clevs 2000'
      'set ccols 0 80'
      'd smth9(smth9(smth9(smth9(smth9(smth9(smth9(smth9(smth9(smth9(smth9(smth9(ave(CIN180_0mb,e=1,e='ee')))))))))))))'
      ...
      'set clab masked'
      'set csmooth on'
      'd smth9(smth9(smth9(smth9(smth9(smth9(smth9(smth9(smth9(smth9(smth9(smth9(ave(CAPE180_0mb,e=1,e='ee')))))))))))))'
    endif
  ...
  endwhile
*  '!mv *'imgname'.png /tstorm/s0/bmburlin/wrf/POST/NCEP/GEFS/images/'imgname
  '!mv *'imgname'.png /tornado/r1/bmburlin/public_html/graphics/GEFS/'imgname
  Clev=Clev+1
endwhile
'quit'
