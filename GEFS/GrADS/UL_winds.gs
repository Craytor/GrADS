...
*  ======================================================================================
*  ==================SET SOME ARBITRARY VALUES FOR WHILE LOOP============================
  count = 0
  t = 1
  fhr = 0
  inc = 6
...
*  '!mv *'lev'_wind.png /tstorm/s0/bmburlin/wrf/POST/NCEP/GEFS/images/'lev'_wind'
  '!mv *'lev'_wind.png /tornado/r1/bmburlin/public_html/graphics/GEFS/'lev'_wind'
*  **************************************************************************************
  wlev=wlev+1
endwhile
'quit'
