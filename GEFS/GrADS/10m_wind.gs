...
*************************************
  ...
  'set e 1'
  'd skip(ave(uwind,e=1,e='ee'),7,7);maskout(ave(vwind,e=1,e='ee'),mag(ave(uwind,e=1,e='ee'),ave(vwind,e=1,e='ee'))-6)'

*===Runs colorbar and prints all text seen on image===*
  'run colorbar/xcbar.gs -direction v -fs 1 -fw .12 -fh .12 -line'
  'set strsiz 0.15'
  'set string 1 l 2'
  'draw string .1 8.25 10m Winds (Knots)'
  'set strsiz 0.11'
...
*'!mv *10m_wind.png /tstorm/s0/bmburlin/wrf/POST/NCEP/GEFS/images/10m_wind'
'!mv *10m_wind.png /tornado/r1/bmburlin/public_html/graphics/GEFS/10m_wind'
***************************************************************************************
'quit'
