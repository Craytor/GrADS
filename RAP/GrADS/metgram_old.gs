...
*    ==========Define RH colors==========
     'set rgb 20 214 109   0 200'
     'set rgb 21 224 145  63 200'
     'set rgb 22 234 182 127 200'
     'set rgb 23 244 218 191 200'
     'set rgb 24 255 255 255 200'
     'set rgb 25 255 255 255 200'
     'set rgb 26 255 255 255 200'
     'set rgb 27 191 225 195 200'
     'set rgb 28 127 196 136 200'
     'set rgb 29  63 167  77 200'
     'set rgb 30   0 138  18 200'
*    ==================================
...
*     ===Get Max and Min 200mb winds in knots===
      'set e 1 'ee
        'set lev 250'
        'define wind10=mag(UGRDprs,VGRDprs)*1.9438444924406'
      'set e 1'
      'set gxout stat'
...
*     ===Get Max and Min precip===
      'set e 1 'ee
        'define prec=sum((ACPCPsfc+NCPCPsfc)/25.4,t=1,t='maxtime')'
      'set e 1'
      'set gxout stat'
      'd ave(prec,e=1,e='ee')'
      rec=sublin(result,9)
...
*     ==================================
   ...
   'set bargap 40'
   'set ccolor 3'
   'd ave((ACPCPsfc+NCPCPsfc)/25.4,e=1,e='ee')'  
