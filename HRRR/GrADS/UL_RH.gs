...
*  ===Runs colorbar and prints all text seen on image===*
  ...
  'set strsiz 0.15'
  'set string 1 l 2'
  'draw string .1 8.25 'lev'mb Relative Humidity (%), Wind Vectors (kts), Heights (gpm)'
  'set strsiz 0.11'
  ...
  'gxprint 'fhr'_'lev'_RH.png x800 y600'
  'clear'
  ...
  endwhile
*  '!mv *'lev'_RH.png /tstorm/s0/bmburlin/wrf/POST/NCEP/'model'/images/'lev'_RH'
  '!mv *'lev'_RH.png /tornado/r1/bmburlin/public_html/graphics/'model'/'lev'_RH'
*  **************************************************************************************
  wlev=wlev+1
endwhile
'quit'
