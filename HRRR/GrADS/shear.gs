...
while (Blev<=2)
  ...
  while (count < numbfor)
    ...
    'set gxout shaded'
    'd smth9(sqrt(pow((vuCSH0_'shear'm*1.94384), 2) + pow((vvCSH0_'shear'm*1.94384), 2)))'
  ...
  if (model = "glHRRR")
    ...
    'set cthick 4'
    'set ccolor 1'
    'define uwind=vuCSH0_'shear'm*1.9438444924406'
    'define vwind=vvCSH0_'shear'm*1.9438444924406'
    'd skip(uwind,20,20);maskout(vwind,mag(uwind,vwind)-'mask')'
