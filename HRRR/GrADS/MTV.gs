...
***Define 850mb Moisture Transport Vector (u and v components) and Magnitude***
  ...
  'set ccolor 1'
  if (model = "glHRRR")
    'd skip(uMTV,20,20);maskout(vMTV,mag(uMTV,vMTV)-10)'
  else
    'd skip(uMTV,30,30);maskout(vMTV,mag(uMTV,vMTV)-10)'
  endif
...
endwhile
*'!mv *MTV.png /tstorm/s0/bmburlin/wrf/POST/NCEP/'model'/images/MTV'
'!mv *MTV.png /tornado/r1/bmburlin/public_html/graphics/'model'/MTV'
***************************************************************************************
'quit'
